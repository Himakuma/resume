...
|インフラ|・サーバー構成の設計、構築<br/>・OSインストール、設定<br/>・Httpサーバー構築<br/>・APサーバー構築<br/>・DBサーバー構築<br/>・ログ、生存監視用ツールの実装<br/>・運用、保守<br/>|サーバー構成の設計、構築は最大でも、<br/>・バランサー１台<br/>・Webサーバー２台（Http、AP共用）<br/>・DBサーバー２台（マスター１、スレーブ１）<br/>・運用、保守<br/>の構成程度<br/><br/>|
...
* UnityのUI制御処理の実装方法の検討・設計・実装
    * 画面単位に対応するクラス定義
    * UIの管理クラスにて、画面とクリック等のイベントを自動的に紐づけ
* アプリへOVRLipsyncの組み込み
